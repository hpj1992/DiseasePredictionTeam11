    ...
    <div class="page-form">
        <div class="panel panel-blue">
            <div class="panel-body pan">
                <div class="col-lg-12">
  				  <div class="note note-danger"><h4 class="box-heading">You are an Existing Member!</h4>
      			   <p>Please login <a href="Login.html" style="color:blue">here</a> and enter your dashboard.</p></div>
                </div>
            </div>
        </div>
    </div>
