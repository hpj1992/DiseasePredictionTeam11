                                ...
                                <div class="row">
                                        ...
                                        <div class="panel panel-green">
                                            ...
                                            <div class="panel-body pan">
                                                <form action="getPredictionFromGene" method="post">
                                                <div class="form-body pal">
                                                    <div class="form-group">
                                                        <label for="inputMessage" class="control-label">
                                                            DNA Sequence</label><textarea rows="5" name="sequence" class="form-control"></textarea></div>
